# -*- coding: utf-8 -*-
# @Time    : 2025/12/15 07:11
# @Author  : DaiPuWei
# @Email   : daipuwei@qq.com
# @File    : dfl_yolo_trt_calibrator.py
# @Software: PyCharm
...
class DFLYOLOCalibrationDataloader(CalibrationDataloader):
    ...
    def __init__(self,logger,input_shape,calibrator_image_dir,use_normalize=False,data_type='float32'):
        ...
        """
        self.logger = logger
        super(DFLYOLOCalibrationDataloader,self).__init__(input_shape=input_shape,
...
def ppyoloe_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    ...
    Returns:
    """
    calibration_dataloader = DFLYOLOCalibrationDataloader(logger,input_shape,calibrator_image_dir,use_normalize,data_type)
    trt_calibrator = TensorRTCalibrator(calibration_dataloader,calibrator_table_path)
    return trt_calibrator

@TENSORRT_CALIBRATION_DATALOADER_REGISTRY.register()
def yolov6_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    这是YOLOX的TensorRT推理引擎INT8校准集加载器的注册函数
    Args:
        logger: 日志类实例
...
@TENSORRT_CALIBRATION_DATALOADER_REGISTRY.register()
def yolov8_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    这是YOLOX的TensorRT推理引擎INT8校准集加载器的注册函数
    Args:
        logger: 日志类实例
...
@TENSORRT_CALIBRATION_DATALOADER_REGISTRY.register()
def yolov9_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    这是YOLOX的TensorRT推理引擎INT8校准集加载器的注册函数
    Args:
        logger: 日志类实例
...
@TENSORRT_CALIBRATION_DATALOADER_REGISTRY.register()
def yolov10_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    这是YOLOX的TensorRT推理引擎INT8校准集加载器的注册函数
    Args:
        logger: 日志类实例
...
@TENSORRT_CALIBRATION_DATALOADER_REGISTRY.register()
def yolov11_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    这是YOLOX的TensorRT推理引擎INT8校准集加载器的注册函数
    Args:
        logger: 日志类实例
...
@TENSORRT_CALIBRATION_DATALOADER_REGISTRY.register()
def yolov12_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    """
    这是YOLOX的TensorRT推理引擎INT8校准集加载器的注册函数
    Args:
        logger: 日志类实例
