...
# @File    : yolov12_trt_calibrator.py
# @Software: CLion

"""
    这是定义YOLOv12校准集数据加载器的脚本
"""
...
class YOLOv12CalibrationDataloader(CalibrationDataloader):
    ...
    def __init__(self,logger,input_shape,calibrator_image_dir,use_normalize=False,data_type='float32'):
        ...
        """
        self.logger = logger
        super(YOLOv12CalibrationDataloader,self).__init__(input_shape=input_shape,
...
def yolov12_trt_calibrator(logger,input_shape,calibrator_image_dir,calibrator_table_path,use_normalize,data_type):
    ...
    Returns:
    """
    calibration_dataloader = YOLOv12CalibrationDataloader(logger,input_shape,calibrator_image_dir,use_normalize,data_type)
