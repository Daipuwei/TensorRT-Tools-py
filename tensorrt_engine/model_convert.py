...
def onnx2tensorrt_engine(logger, onnx_model_path, tensorrt_model_path, mode, calibrator=None):
    """
    这是ONNX转TensorRT的函数
    Args:
        logger: 日志实例
    ...
    if trt_version >= 10:
        onnx2tensorrt_engine_v10(logger, onnx_model_path, tensorrt_model_path, mode, calibrator)
    elif trt_version >= 8:
        onnx2tensorrt_engine_v8(logger, onnx_model_path, tensorrt_model_path, mode, calibrator)
    else:
        onnx2tensorrt_engine_v7(logger, onnx_model_path, tensorrt_model_path, mode, calibrator)

def onnx2tensorrt_engine_v7(logger, onnx_model_path, tensorrt_model_path, mode, calibrator=None):
    """
...
def onnx2tensorrt_engine_v8(logger, onnx_model_path, tensorrt_model_path, mode, calibrator=None):
    """
...
def onnx2tensorrt_engine_v10(logger, onnx_model_path, tensorrt_model_path, mode, calibrator=None):
    """
    这是ONNX转TensorRT的函数,支持TensorRT8.x及其更高版本
    Args:
        logger: 日志实例
